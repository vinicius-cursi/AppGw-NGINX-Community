...
# Upstream para o health probe. Não precisa de health check, pois ele é o próprio check.
...
# Configuração principal do servidor HTTPS
server {
...
#### A. Script de Verificação do NGINX
...
**Arquivo:** `/etc/keepalived/check_nginx.sh`
...
#### B. Configuração do Keepalived - Servidor NGINX-01 (MASTER)
...
#### C. Configuração do Keepalived - Servidor NGINX-02 (BACKUP)
